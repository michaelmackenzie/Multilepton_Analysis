//Script to plot histograms generated by CLFVHistMaker
...
int initialize_data(TString selection = "emu") {
  ...
  cards.push_back(datacard(("clfv_"+selection+"_bltTree_zemu.hist"          ).Data(), "bltTree_zemu"          , "Z->e#mu"    , false, 0.028, true , kBlue));
  cards.push_back(datacard(("clfv_"+selection+"_bltTree_hemu.hist"          ).Data(), "bltTree_hemu"          , "H->e#mu"    , false, 0.015, true , kOrange));
  cards.push_back(datacard(("clfv_"+selection+"_bltTree_htautau_gluglu.hist").Data(), "bltTree_htautau_gluglu", "H->#tau#tau", false, 3.07 , false, kViolet-3));
  cards.push_back(datacard(("clfv_"+selection+"_bltTree_t_tw.hist"          ).Data(), "bltTree_t_tw"          , "Top"        , false, 35.85, false, kYellow-7));
  cards.push_back(datacard(("clfv_"+selection+"_bltTree_tbar_tw.hist"       ).Data(), "bltTree_tbar_tw"       , "Top"        , false, 35.85, false, kYellow-7));
  int status = 0;
