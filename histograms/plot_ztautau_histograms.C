...
Int_t init_files() {
  ...
  xsec_[15] =  11486.53; //9493.;      //"w1jets"                  
  xsec_[16] =  3775.2; //3120.;	       //"w2jets"                  
  xsec_[17] =  1139.82; //942.3;       //"w3jets"                  
  xsec_[18] =  655.82; //524.1;	       //"w4jets"                  
  xsec_[19] =  12.178;	               //"ww"                      
  ...
  xsec_[31] =                   6.32e-2* 43.92;	       //"htautau_gluglu"                  
