...
Int_t do_fit(TTree* tree, int set, int year) {
  ...
  RooRealVar beta_n_muon("beta_n_muon", "beta_n_muon", 0., -5., 5.);
  RooRealVar beta_n_electron("beta_n_electron", "beta_n_electron", 0., -5., 5.);
  ...
  RooRealVar tau_bkg("tau_bkg", "tau_bkg", -0.0583634, -5000., 0.);
