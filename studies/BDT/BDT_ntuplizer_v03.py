...
input_files_mc={
  "zemu":"root://cmseos.fnal.gov//store/user/mmackenz/lfvanalysis_rootfiles/LFVAnalysis_ZEMu_*.root",
  "DY50":"root://cmseos.fnal.gov//store/user/mmackenz/lfvanalysis_rootfiles/LFVAnalysis_DY50*.root",
  "WW":"root://cmseos.fnal.gov//store/user/mmackenz/lfvanalysis_rootfiles/LFVAnalysis_WW_*.root",
  "ttbar":"root://cmseos.fnal.gov//store/user/mmackenz/lfvanalysis_rootfiles/LFVAnalysis_ttbar*.root",
}
...
if __name__ == "__main__":
   ...
   parser.add_argument("--process", dest="process",default="zemu", type=str,help="signal/background process to consider")
   ...
   cc = rt.TChain(args.dilep)   

   cc.Add(input_files_mc[args.process])
   ...
   print "TChain has %i events to process" % (cc.GetEntries())
   
   fout = rt.TFile("bdt_tree_v2_"+args.dilep+"_"+args.process+"_"+args.name+".root","RECREATE")
   ...
   for evt in cc:
     ievt+=1
     if ievt%10000==0: print "Processing event %12i" % (ievt)
