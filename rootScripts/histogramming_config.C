...
int useQCDWeights_     = 0; //use QCD SS --> OS transfer weights
...
vector<datacard_t> get_data_cards(TString& nanoaod_path) {
  ...
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("Wlnu"                    ), "LFVAnalysis_Wlnu_2016.root"                    , 0, useUL_));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("Wlnu"                    ), "LFVAnalysis_Wlnu-ext_2016.root"                , 0, useUL_));
  ...
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich20to30"       ), "LFVAnalysis_QCDEMEnrich20to30_2016.root"       , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich30to50"       ), "LFVAnalysis_QCDEMEnrich30to50_2016.root"       , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich50to80"       ), "LFVAnalysis_QCDEMEnrich50to80_2016.root"       , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich80to120"      ), "LFVAnalysis_QCDEMEnrich80to120_2016.root"      , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich120to170"     ), "LFVAnalysis_QCDEMEnrich120to170_2016.root"     , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich170to300"     ), "LFVAnalysis_QCDEMEnrich170to300_2016.root"     , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDEMEnrich300toInf"     ), "LFVAnalysis_QCDEMEnrich300toInf_2016.root"     , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDDoubleEMEnrich30to40" ), "LFVAnalysis_QCDDoubleEMEnrich30to40_2016.root" , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDDoubleEMEnrich30toInf"), "LFVAnalysis_QCDDoubleEMEnrich30toInf_2016.root", 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("QCDDoubleEMEnrich40toInf"), "LFVAnalysis_QCDDoubleEMEnrich40toInf_2016.root", 0));
  ...
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("ZETau"                   ), "LFVAnalysis_ZETau_2016.root"                   , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("ZMuTau"                  ), "LFVAnalysis_ZMuTau_2016.root"                  , 0));
  nanocards.push_back(datacard_t(true , xs.GetCrossSection("ZEMu"                    ), "LFVAnalysis_ZEMu_2016.root"                    , 0));
