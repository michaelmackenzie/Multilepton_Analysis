...
Int_t process_multileptonNT() {
  ...
  const char* gridPath[] = {
    ...
    "/eos/uscms/store/user/mmackenz/batch_output/mumu_2016_20190620_122923/", //signal samples
    "/eos/uscms/store/user/mmackenz/batch_output/mumu_2016_20190307_163959/", 
    "/eos/uscms/store/user/mmackenz/batch_output/mumu_2016_20190307_163959/", 
    "/eos/uscms/store/user/mmackenz/batch_output/mumu_2016_20190307_163959/", 
    "/eos/uscms/store/user/mmackenz/batch_output/mumu_2016_20190620_122923/"}; 
  ...
  for(int i = 0; i < sizeof(files)/sizeof(*files); ++i) {
    ...
    tree->Process(selec,"");
    TFile* out = new TFile(Form("%s.tree",tree->GetName()),"UPDATE");
    if(out == 0) {
